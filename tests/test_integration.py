...
class TestEcosystemIntegration(unittest.TestCase):
    ...
    def test_reasoning_consistency(self):
        ...
        g.parse(str(ontologies_dir / "sounding_rocket.ttl"), format="turtle")
        g.parse(str(ontologies_dir / "insulin_cooler.ttl"), format="turtle")
        g.parse(str(ontologies_dir / "uaf_traceability_shapes.ttl"), format="turtle")
